...
function renderGallery(){
  ...
  const photos=getArtistPhotos('nono');
  g.innerHTML=photos.map(src=>`<div class="g-item"><img src="${src}" alt="no-no" style="width:100%;height:100%;object-fit:cover;"></div>`).join('');
}
